...
module.exports = async (dirOrPath, { Topic }, opts = {}) => {
  ...
  if (common.isGithubUrl(dirOrPath)) {
    ...
    const url = `https://api.github.com/repos/${username}/${repository}/contents/README.md?access_token=${token}&ref=${branch}`;
    ...
    const readmePath = path.join(dir, common.getReadmeFileName(opts.locale));
    ...
    location = path.join(dir, 'README.md');
  }
